...
export const BannerAdd: React.FC<BannerAddProps> = ({ toggleAdd }) => {
    ...
    const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
        ...
        if (banner.imageFile) {
            formData.append("imageName", banner.imageFile.name);
