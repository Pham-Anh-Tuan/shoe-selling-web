            ...
            <div className="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="flex items-center space-x-4 justify-end">
                        <button type="submit" className="text-white bg-orange-400 hover:bg-orange-500 font-medium rounded-md text-sm px-5 py-2.5 text-center dark:bg-orange-400 dark:hover:bg-orange-500">Cập nhật</button>
                        <button onClick={toggleUpdate}
