        ...
        <div className="p-4 w-full h-screen overflow-auto bg-gray-100 dark:bg-gray-900">
            <section className="antialiased mt-16 z-10">
                <div className="mx-auto w-full">
                    ...
                    {/* ádasd */}
                    <div className="bg-white dark:bg-gray-800 relative shadow-md overflow-hidden rounded-md">
            ...
            {/* <button id={index + "giay-the-thao-1-dropdown-button"}
                                                    onClick={() => {
                                                        ...
                                                        const dropdown = document.getElementById(productIndex + "giay-the-thao-1-dropdown");
                                                        dropdown?.classList.toggle("hidden");
            ...
            {/* <div id={productIndex + "giay-the-thao-1-dropdown"}
                className="hidden absolute right-0 top-[100px] z-30 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600"
            >
                <ul className="py-1 text-sm" aria-labelledby={productIndex + "giay-the-thao-1-dropdown-button"}>
                    <li>
                        <button onClick={() => {
                            toggleUpdate();
                        }}
